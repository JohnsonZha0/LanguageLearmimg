...
public class Menu extends JFrame implements ActionListener{
    ...
    public Menu()
    {
        ...
        jlb1 = new JLabel("警方提醒：");
        jlb1.setFont(new   java.awt.Font("Dialog",   1,   20)); //设置字体类型， 是否加粗，字号
        jlb2 = new JLabel("请勿轻易将存款转入假冒公安、电信");
        jlb2.setFont(new   java.awt.Font("Dialog",   1,   13));
        jlb3 = new JLabel("和银行工作人员提供的所谓安全账户！");
        jlb3.setFont(new   java.awt.Font("Dialog",   1,   13));
        jlb4 = new JLabel("请您选择服务");
        jlb4.setFont(new   java.awt.Font("Dialog",   1,   30));
        ...
        this.setTitle("Z银行管理管理系统");  //设置窗体标题
        ...
        //设置标签的位置和大小
        jlb1.setBounds(100,120,300,50);
        jlb2.setBounds(100,160,300,50);
        jlb3.setBounds(100,180,300,50);
        jlb4.setBounds(120,250,300,50);
